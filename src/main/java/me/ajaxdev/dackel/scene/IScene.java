...
public interface IScene {
    ...
    void drawBackground(double windowWidth, double windowHeight, double delta);

    void drawGame(double windowWidth, double windowHeight, double delta);

    void drawOverlay(double windowWidth, double windowHeight, double delta);
